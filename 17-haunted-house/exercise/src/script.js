...
// Walls
const wallsHeigth = 2.5;
const wallsWidth = 4;
const walls = new THREE.Mesh(
  new THREE.BoxGeometry(wallsWidth, wallsHeigth, 4),
...
walls.position.y = wallsHeigth / 2;
house.add(walls);

// Roof
const roofHeigth = 1;
const roof = new THREE.Mesh(
  new THREE.ConeGeometry(3.5, roofHeigth, 4),
  new THREE.MeshStandardMaterial({ color: "#b35f45" })
);
roof.position.y = wallsHeigth + roofHeigth / 2;
roof.rotation.y = Math.PI / 4;
house.add(roof);

// Door
const doorHeigth = 2.2;
const doorWidth = 2.2;
const door = new THREE.Mesh(
  new THREE.PlaneGeometry(doorHeigth, doorWidth, 100, 100),
  new THREE.MeshStandardMaterial({
...
bush3.scale.set(bushRadius / 3, bushRadius / 3, bushRadius / 3);
bush3.position.set(-0.8, 0.1, 2.2);

const bush4 = new THREE.Mesh(bushGeometry, bushMaterial);
bush4.scale.set(bushRadius / 6, bushRadius / 6, bushRadius / 6);
